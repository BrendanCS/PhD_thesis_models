...
# COMMENTS -------------------------------------------------
# In this model a fear state becomes available to the agent as a simple non-propositional pattern (a neural pattern in the amygdala - see separate amydala .py file). 
# Support for cognitive modeling of affect is drawn from papers (West & Young, 2017; West & Conway-Smith, 2019; Conway-Smith & West, 2022).
# Affect (i.e., emotion, feeling) take the form of non-propositional patterns in buffers. 
# Emotion (i.e., fear of spider) is represented here are binary code (e.g., 1010101) representing affective neuronal pattern activations. 
# Feelings as neural patterns can be recognized using Type-1 procedural metacognition.
# Feelings can also be conceptually recognized and 'enriched' i.e., represented by propostions such as 'I feel fear.' 
# These patterns are represented as low, medium, and high fear arousal states.  
