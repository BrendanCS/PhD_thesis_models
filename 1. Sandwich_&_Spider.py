...
# -------------------------
# This model entails the agent engaging in a simple task (making a sandwich), during which a spider becomes visible. 
# This is a simple base model that employs the relevant modules, buffers, and procedures. 
# -------------------------
# Initialize Memories
# -------------------------
working_memory = {
...
AllProductionSystems = {
    ...
    'ProductionSystem7': [Trace_Productions, ProductionSystem6_Countdown],
